...
def plot_graph(prefix, coll):
	...
	for store, color in options:
		...
		barargs = {'drawable':d, 'table':subt,
					'xfield' : 'line', 'yfield' : coll, 'labelfield':coll,
	...
	#			}
	#
	L.draw(c, coord = [d.left()+90, d.top()-10], skipnext=2, skipspace=40)
	c.render()
...
if __name__ == "__main__":
	workloads=["ycsba", "ycsbb", "ycsbc", "ycsbd", "ycsbe", "ycsbf"]
	workloads=["swift_1m", "swift_4k"]
	for w in workloads:
		print w
		plot_graph(w, 'iops')
#		plot_graph(w, 'bw')
